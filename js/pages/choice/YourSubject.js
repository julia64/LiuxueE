...
import CNsubject from '../../../res/data/CNsubject'
import RepositoryCell from '../../common/RepositoryCell'

export default class YourSubject extends Component {
    constructor(props) {
        super(props);
        this.state = {
            text:'',
    ...
    loadData(){
            this.setState({
                dataSource:this.getDataSource(CNsubject)
            });
    }
    getDataSource(items){
